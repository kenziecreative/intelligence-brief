...
market band of $10–20/user/mo [Source: note-analyst-roundup.md]. At 24 seats that is
$288–432/mo. The
...
The deciding factor is security fit: Helpdock supports SAML SSO on Pro and above
[Source: note-helpdock.md]; **Replyline does not support SAML SSO** — only Google OAuth,
confirmed in the trial account [Source: note-replyline.md]. SSO is the top gating
requirement for security-conscious SMBs [Source: note-analyst-roundup.md].

Implementation: plan for **3 weeks** — Helpdock's median for teams of 20–50 seats
[Source: note-helpdock.md]. Helpdock Pro carries a 4-business-hour first-response SLA;
Replyline commits to none [Source: note-replyline.md].

## What would show this wrong

The recommendation is falsifiable on two planned measurements: (1) if the negotiated
annual quote at contract time lands above $18/seat, the cost case fails and the decision
reopens; (2) if Helpdock's first-response times exceed the 4-business-hour SLA in the
first 60 days post-implementation (measured from the ticket system's SLA report, per the
risk register's monitoring rows), the SLA case fails. Either result refutes the core
recommendation.
...
Replyline's pricing (one source each; capability claims per the evidence standard trace
to vendor docs/trial). Waivers: none.
