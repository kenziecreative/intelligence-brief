---
description: Save the session — update loop state and write the working debrief before you stop
...
and writes the session debrief (working dynamic, open questions, backstage prep) so a
